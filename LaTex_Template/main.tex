\documentclass[a4paper,12pt,UTF8,oneside,hyperref]{ctexart}%twoside可设置双面打印格式;
...
%==========================插入图片=============================
\usepackage{graphicx}
\usepackage{subcaption}%两图并排
\usepackage{picinpar}%文字绕排
\usepackage{caption}
\graphicspath{{./pictures/}}%设置图片放置路径
...
%=============================文献格式===============================
\usepackage[sort]{gbt7714}%文献格式使用GB/T7714-2015标准；
\newcommand{\upcite}[1]{\textsuperscript{\textsuperscript{\cite{#1}}}}
\usepackage{natbib}
\renewcommand\bibfont{\small\kaishu}%文献改用5号楷书字体；
...
\nocite{*}
\bibliographystyle{gbt7714-numerical}%命令选择参考文献样式
%\bibliographystyle{gbt7714-author-year}  
\bibliography{./literature/thesis}
\titleformat{\section}[hang]{\heiti\large\center}{附录\,\thesection \quad}{0pt}{}{}
\input{appendix.tex}
\end{document}
